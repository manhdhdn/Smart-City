        ...
        <ScrollView>
            <View style={styles.signin}>
                <View style={[styles.content, styles.buttonPosition]}>
                    ...
                    <Pressable style={styles.doseNotHaveContainer} onPress={handleRegisterLinkPress}>
                        <Text style={[styles.doseNotHave, styles.textStyle]}>Dose not have account?</Text>
                        <Text style={[styles.register, styles.textStyle]}>Register</Text>
                    </Pressable>
                </View>
            </View>
        </ScrollView>
